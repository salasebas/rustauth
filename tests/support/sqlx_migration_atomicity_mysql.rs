//! MySQL migration rollback assertions for SQLx adapter integration tests.
...
pub async fn assert_mysql_migration_plan_rolls_back(
    adapter: &rustauth_sqlx::MySqlAdapter,
    pool: &sqlx::MySqlPool,
    schema: &DbSchema,
