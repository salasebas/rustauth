//! Postgres migration rollback assertions for SQLx adapter integration tests.
...
pub async fn assert_postgres_migration_plan_rolls_back(
    adapter: &rustauth_sqlx::PostgresAdapter,
    pool: &sqlx::PgPool,
    schema: &DbSchema,
