...
const adapters: CommunityAdapter[] = [
	{
		name: "convex-rustauth",
		url: "https://github.com/get-convex/rustauth",
		database: "Convex",
	...
	{
		name: "surreal-rustauth",
		url: "https://github.com/oskar-gmerek/surreal-rustauth",
		database: "SurrealDB",
	...
	{
		name: "surrealdb-rustauth",
		url: "https://github.com/Necmttn/surrealdb-rustauth",
		database: "SurrealDB",
		databaseUrl: "https://surrealdb.com/",
		author: {
			name: "Necmttn",
	...
	{
		name: "rustauth-surrealdb",
		url: "https://github.com/msanchezdev/rustauth-surrealdb",
		database: "SurrealDB",
		databaseUrl: "https://surrealdb.com/",
		author: {
			name: "msanchezdev",
	...
	{
		name: "@payload-auth/rustauth-plugin",
	...
	{
		name: "@delmaredigital/payload-rustauth",
		url: "https://github.com/delmaredigital/payload-rustauth",
		database: "Payload CMS",
		databaseUrl: "https://payloadcms.com/",
		author: {
	...
	{
		name: "rustauth-instantdb",
		url: "https://github.com/daveyplate/rustauth-instantdb",
		database: "InstantDB",
	...
	{
		name: "@nerdfolio/remult-rustauth",
		url: "https://github.com/nerdfolio/remult-rustauth",
		database: "Remult",
	...
	{
		name: "pocketbase-rustauth",
		url: "https://github.com/LightInn/pocketbase-rustauth",
		database: "PocketBase",
	...
	{
		name: "rustauth-firestore",
		url: "https://github.com/yultyyev/rustauth-firestore",
	...
	{
		name: "@zenstackhq/rustauth",
		url: "https://github.com/zenstackhq/zenstack-v3/tree/main/packages/auth-adapters/rustauth",
		database: "ZenStack",
	...
	{
		name: "@strapi-community/plugin-rustauth",
		url: "https://github.com/strapi-community/plugin-rustauth",
		database: "Strapi CMS",
