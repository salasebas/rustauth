				...
				subpages: [
					{
						...
						icon: () => <AdapterIcons.redis className="w-4 h-4" />,
					},
					{
						title: "Fred",
						href: "/docs/adapters/fred",
						icon: () => <AdapterIcons.redis className="w-4 h-4" />,
					},
				],
			},
...
C0.7,239.6,62.1,0.5,62.2,0.4c0,0,54,13.8,119.9,30.8S302.1,62,302.2,62c0.2,0,0.2,0.4,0.1,0.9c-0.2,1.5-61.5,239.3-61.7,239.5
	...
	},
	{
		...
		list: [
			{
				title: "SQLx",
				href: "/docs/adapters/sqlx",
				icon: () => <AdapterIcons.rust className="w-4 h-4" />,
			},
			{
				title: "Diesel",
				href: "/docs/adapters/diesel",
				icon: () => <AdapterIcons.rust className="w-4 h-4" />,
			},
			{
				title: "Deadpool Postgres",
				href: "/docs/adapters/deadpool-postgres",
				icon: () => <AdapterIcons.postgresql className="w-4 h-4" />,
			},
			{
				title: "Tokio Postgres",
				href: "/docs/adapters/tokio-postgres",
				icon: () => <AdapterIcons.postgresql className="w-4 h-4" />,
			},
			{
				title: "MongoDB",
				href: "/docs/adapters/mongo",
				icon: () => <AdapterIcons.mongodb className="w-4 h-4" />,
	...
	},
	{
		...
		list: [
			{
				title: "Axum",
				icon: () => <IntegrationIcons.axum className="w-4 h-4" />,
				href: "/docs/integrations/axum",
			},
			{
				title: "Actix Web",
				icon: () => <IntegrationIcons.actixWeb className="w-4 h-4" />,
				href: "/docs/integrations/actix-web",
			},
		],
	},
	{
		...
		list: [
			...
			{
				title: "Access",
				href: "/docs/plugins/access",
				icon: () => <Shield className="w-4 h-4" />,
			},
			{
				title: "Additional Fields",
				href: "/docs/plugins/additional-fields",
			...
			},
			{
				...
				href: "/docs/plugins/custom-session",
			},
			{
