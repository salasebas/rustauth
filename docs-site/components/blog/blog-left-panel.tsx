...
export function BlogLeftPanel({ postCount, post }: BlogLeftPanelProps) {
	if (post) {
		return (
			<div className="relative w-full lg:w-[30%] lg:h-dvh lg:sticky lg:top-0 border-b lg:border-b-0 lg:border-r border-foreground/[0.06] overflow-hidden px-5 sm:px-6 lg:px-10 bg-background">
				<HalftoneBackground />
