...
import { SchemaCatalog } from "@/components/docs/schema-catalog";
...
export default async function Page({
	...
	// Upstream content always lives at docs-site/content/docs on each branch;
	// `content/docs-beta` is only a local sync target, not in the repo tree.
	const rawBase = `https://raw.githubusercontent.com/salasebas/rustauth/${version.branch}/docs-site/content/docs`;
	const githubBase = `https://github.com/salasebas/rustauth/blob/${version.branch}/docs-site/content/docs`;
	...
	return (
		...
		>
			...
			<DocsBody>
				...
				/>
				<DocsAttribution className="mt-10 pt-6 border-t border-foreground/10 not-prose" />
			</DocsBody>
		</DocsPage>
	);
}
