...
const ctaHref = `https://github.com/salasebas/rustauth?callbackUrl=${encodeURIComponent("/?redirectTo=/settings/billing")}`;
...
const pricingTiers = [
	{
		...
		cta: "Get Started",
		ctaHref: "https://github.com/salasebas/rustauth",
		...
		<div className="px-5 sm:px-6 lg:px-8 pb-16 space-y-10">
			...
			>
				...
				<p className="text-sm sm:text-[15px] text-foreground/80 leading-relaxed max-w-lg mb-8">
					Connect to our infrastructure and power your self-hosted RustAuth
