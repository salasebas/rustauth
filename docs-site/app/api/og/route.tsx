...
const ogSchema = z.object({
	heading: z.string().default("RustAuth Documentation"),
			...
			>
				...
				>
					...
					<div tw="flex flex-col flex-1 py-10">
						...
						>
							<rect x="9" y="8.5" width="4.5" height="15" rx="1.2" fill="white" />
							<rect
								x="12.8"
								y="8.5"
								width="11.5"
							...
							<rect
								...
								fill="white"
							/>
							<circle cx="25" cy="9.5" r="1.8" fill="#DE622A" />
						</svg>
						<div
