---
title: RustAuth Infrastructure
description: Enterprise-grade dashboard, security, and managed services for RustAuth.
---

RustAuth Infrastructure is a paid service that extends your authentication system with a management dashboard,
