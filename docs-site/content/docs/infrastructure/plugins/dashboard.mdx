---
title: Dashboard
description: The `dash()` plugin connects your RustAuth instance to RustAuth Infrastructure, enabling analytics tracking, activity monitoring, and admin dashboard APIs.
---

The Dashboard plugin is the core connection between your RustAuth instance and RustAuth Infrastructure. It powers the web dashboard with real-time data, tracks user activity, and enables admin APIs.
...
| ------------------ | -------- | ---------------------------------- |
| `apiUrl`           | `string` | RustAuth Infrastructure API URL |
...
Once `dash()` is active, the RustAuth Infrastructure dashboard gives you:
