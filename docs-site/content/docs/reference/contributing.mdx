---
title: Contributing to RustAuth
description: A concise guide to contributing to RustAuth
---

Thank you for your interest in contributing to RustAuth! This guide is a concise guide to contributing to RustAuth.

## Getting Started

Before diving in, here are a few important resources:

* Take a look at our existing <Link href="https://github.com/salasebas/rustauth/issues">issues</Link> and <Link href="https://github.com/salasebas/rustauth/pulls">pull requests</Link>
* Join our community discussions in <Link href="https://discord.gg/rustauth">Discord</Link>
...
<Steps>
  <Step>
    ...
    Visit [https://github.com/salasebas/rustauth](https://github.com/salasebas/rustauth)
  ...
  <Step>
    ...
    git clone https://github.com/YOUR-USERNAME/rustauth.git
    cd rustauth
    ```
  </Step>
...
<Steps>
  <Step>
    ...
    git remote add upstream https://github.com/salasebas/rustauth.git
...
* Check our [GitHub issues](https://github.com/salasebas/rustauth/issues) for tasks labeled `good first issue`
...
* Open an <Link href="https://github.com/salasebas/rustauth/issues">issue</Link> with questions
* Join our <Link href="https://discord.gg/rustauth">community discussions</Link>
