...
> = {
	...
	access: {
		...
		icon: "Shield",
		tagline: "Role-based access control helpers for admin and org plugins",
	},
	"additional-fields": {
		category: "Authorization",
		icon: "Columns3",
		tagline: "Extend user and session schema with custom fields",
	},
	admin: {
		category: "Authorization",
		icon: "ShieldCheck",
	...
	"custom-session": {
		category: "Utility",
		icon: "Braces",
		tagline: "Customize get-session JSON responses",
	},
