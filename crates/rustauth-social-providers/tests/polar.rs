...
use rustauth_oauth::oauth2::{ClientId, OAuth2Tokens, OAuthError, ProviderOptions};
use rustauth_social_providers::advanced::polar::{
    polar, PolarAuthorizationUrlRequest, PolarOptions, PolarProfile, PolarProvider,
};

#[test]
fn polar_provider_exposes_upstream_metadata() {
    let provider = polar(PolarOptions {
