...
use rustauth_oauth::oauth2::{ClientId, ClientSecret, OAuth2Tokens, ProviderOptions};
use rustauth_social_providers::advanced::huggingface::{
...
fn huggingface_partial_mapper_overrides_selected_user_fields() {
    let provider = huggingface(HuggingFaceOptions {
        ...
        map_profile_to_user: Some(Arc::new(|profile| {
            let mut patch =
                rustauth_social_providers::advanced::huggingface::HuggingFaceUserPatch::default();
...
fn profile_without_verified_email() -> HuggingFaceProfile {
    HuggingFaceProfile {
        ...
        orgs: Some(vec![HuggingFaceOrg {
            sub: "org-1".to_owned(),
            name: "RustAuth".to_owned(),
            picture: "https://cdn.example.com/org.png".to_owned(),
            preferred_username: "rustauth".to_owned(),
