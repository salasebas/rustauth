...
use rustauth_oauth::oauth2::{ClientId, OAuth2Tokens, OAuthError};
use rustauth_social_providers::advanced::cognito::{
    cognito, cognito_issuer, cognito_jwks_uri, CognitoAuthorizationUrlInput, CognitoOptions,
};
use rustauth_social_providers::advanced::http::ProviderHttpClient;
...
fn test_provider() -> rustauth_social_providers::advanced::cognito::CognitoProvider {
