...
use rustauth_social_providers::advanced::vk::{
...
async fn vk_get_user_info_returns_none_when_access_token_is_missing() -> Result<(), OAuthError> {
    ...
    let info = provider
        .get_user_info(&rustauth_oauth::oauth2::OAuth2Tokens::default())
        .await?;
...
impl VkOptionsFixture {
    fn into_options(self) -> rustauth_social_providers::advanced::vk::VkOptions {
        rustauth_social_providers::advanced::vk::VkOptions {
