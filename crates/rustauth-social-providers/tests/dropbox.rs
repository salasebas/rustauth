...
use rustauth_oauth::oauth2::{ClientId, ProviderOptions};
use rustauth_social_providers::advanced::dropbox::{
    dropbox, DropboxAccessType, DropboxAuthorizationUrlRequest, DropboxName, DropboxProfile,
...
fn dropbox_provider_exposes_upstream_metadata() {
    let provider = dropbox(DropboxProviderOptions {
