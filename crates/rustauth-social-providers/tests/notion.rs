...
use rustauth_oauth::oauth2::{ClientId, ClientSecret, ProviderOptions};
use rustauth_social_providers::advanced::notion::{
    notion, NotionAuthorizationUrlRequest, NotionOwner, NotionOwnerUser, NotionPerson,
    NotionProfile, NotionProvider, NotionUserInfoResponse,
};

#[test]
fn notion_provider_exposes_upstream_metadata() {
    let provider = notion(ProviderOptions {
