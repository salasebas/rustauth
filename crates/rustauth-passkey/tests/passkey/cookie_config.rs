...
use rustauth_core::cookies::{parse_set_cookie_header, ParsedCookie};
use rustauth_core::options::{AdvancedOptions, CookieAttributesOverride, CookieConfig};
...
async fn passkey_challenge_cookie_inherits_cross_subdomain_and_default_attributes(
    ...
    assert_eq!(name, "__Secure-rustauth.better-auth-passkey");
