...
pub const SCIM_PROVIDER_MODEL: &str = "scim_provider";
pub const SCIM_USER_PROFILE_MODEL: &str = "scim_user_profile";
pub const SCIM_GROUP_PROFILE_MODEL: &str = "scim_group_profile";
