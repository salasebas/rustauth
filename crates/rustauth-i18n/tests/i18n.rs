...
use rustauth_core::api::{create_auth_endpoint, AuthEndpointOptions, AuthRouter};
use rustauth_core::auth::email_password::AuthFlowErrorCode;
use rustauth_core::context::{create_auth_context, request_state::set_current_session_user};
...
async fn translates_rate_limit_on_early_router_exit() -> Result<(), Box<dyn std::error::Error>> {
    use rustauth_core::options::{RateLimitOptions, RateLimitPathRule, RateLimitRule};
...
async fn session_detection_reads_locale_from_session_cookie_hydration(
    ...
    use rustauth_core::api::{core_auth_async_endpoints, json_response, ApiErrorResponse};
    use rustauth_core::context::create_auth_context_with_adapter;
    use rustauth_core::db::DbAdapter;
    use rustauth_core::db::DbFieldType;
    use rustauth_core::options::{AdvancedOptions, UserAdditionalField, UserOptions};
...
async fn translates_invalid_origin_on_security_short_circuit(
    ...
    use rustauth_core::api::core_auth_async_endpoints;
    use rustauth_core::options::{AdvancedOptions, TrustedOriginOptions};
...
async fn translates_error_from_on_request_plugin_short_circuit(
    ...
    use rustauth_core::api::json_response;
    use rustauth_core::plugin::{AuthPlugin, PluginRequestAction};
    ...
    let early_plugin = AuthPlugin::new("early-error").with_on_request(|_context, _request| {
        let response = json_response(
            http::StatusCode::BAD_REQUEST,
            &rustauth_core::api::ApiErrorResponse {
