...
pub fn to_exp_jwt(expiration_time: TimeInput, iat: i64) -> Result<i64, RustAuthError> {
...
) -> Result<JwtClaims, RustAuthError> {
...
fn parse_duration(value: &str) -> Result<i64, RustAuthError> {
...
fn invalid_duration(value: &str) -> RustAuthError {
    RustAuthError::InvalidConfig(format!("invalid JWT duration `{value}`"))
}
