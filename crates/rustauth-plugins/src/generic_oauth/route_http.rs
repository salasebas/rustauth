...
use rustauth_core::api::{ApiResponse, BodyField, BodySchema, JsonSchemaType};
...
pub(super) fn json_response<T: Serialize>(
    ...
    http::Response::builder()
        ...
        .body(serde_json::to_vec(value).map_err(|error| RustAuthError::Api(error.to_string()))?)
...
pub(super) fn redirect(location: &str, cookies: Vec<Cookie>) -> Result<ApiResponse, RustAuthError> {
