...
pub fn forbidden(error: PluginErrorCode) -> Result<ApiResponse, RustAuthError> {
    error_response(StatusCode::FORBIDDEN, error.code, error.message)
}

pub fn bad_request(error: PluginErrorCode) -> Result<ApiResponse, RustAuthError> {
...
pub fn not_found_user() -> Result<ApiResponse, RustAuthError> {
