...
pub use options::{CaptchaOptions, CaptchaOptionsBuilder, CaptchaProvider, DEFAULT_ENDPOINTS};

use std::sync::Arc;

use response::error_response;
use rustauth_core::error::RustAuthError;
use rustauth_core::plugin::{AuthPlugin, PluginErrorCode};
...
pub fn captcha(options: CaptchaOptions) -> Result<AuthPlugin, RustAuthError> {
    options
        .validate()
