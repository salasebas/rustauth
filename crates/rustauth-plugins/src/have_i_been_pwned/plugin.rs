...
use rustauth_core::plugin::{AuthPlugin, PluginErrorCode, PluginPasswordValidationRejection};
...
#[must_use]
pub fn have_i_been_pwned(options: HaveIBeenPwnedOptions) -> AuthPlugin {
