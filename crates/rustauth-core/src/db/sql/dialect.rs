...
impl SqlDialect {
    ...
    pub fn where_clause(
        ...
        table: &DbTable,
        clauses: &[Where],
    ) -> Result<SqlFragment, RustAuthError> {
...
fn validate_identifier(dialect: SqlDialect, identifier: &str) -> Result<(), RustAuthError> {
...
fn invalid_identifier(dialect: SqlDialect, identifier: &str) -> RustAuthError {
...
mod tests {
    ...
    #[test]
    fn where_clause_applies_insensitive_mode_to_eq() -> Result<(), RustAuthError> {
        let clause =
    ...
    #[test]
    fn where_clause_applies_insensitive_mode_to_ne() -> Result<(), RustAuthError> {
    ...
    #[test]
    fn where_clause_applies_insensitive_mode_to_in() -> Result<(), RustAuthError> {
    ...
    #[test]
    fn where_clause_applies_insensitive_mode_to_not_in() -> Result<(), RustAuthError> {
        let clause = Where::new(
            "email",
    ...
    #[test]
    fn where_clause_escapes_like_wildcards_for_contains() -> Result<(), RustAuthError> {
    ...
    #[test]
    fn where_clause_escapes_like_wildcards_for_starts_with() -> Result<(), RustAuthError> {
    ...
    #[test]
    fn where_clause_escapes_like_wildcards_for_insensitive_ends_with() -> Result<(), RustAuthError>
    {
