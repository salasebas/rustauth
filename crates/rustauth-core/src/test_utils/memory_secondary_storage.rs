...
impl MemorySecondaryStorage {
    ...
    pub fn value(&self, key: &str) -> Result<Option<String>, RustAuthError> {
    ...
    pub fn ttl_for_key(&self, key: &str) -> Result<Option<u64>, RustAuthError> {
    ...
    pub fn has_key(&self, key: &str) -> Result<bool, RustAuthError> {
    ...
    fn entries(
        &self,
    ) -> Result<std::sync::MutexGuard<'_, HashMap<String, StoredEntry>>, RustAuthError> {
        self.state
            .entries
            .lock()
            .map_err(|_| RustAuthError::Adapter("secondary storage mutex poisoned".to_owned()))
    }

    fn purge_expired(&self) -> Result<(), RustAuthError> {
    ...
    fn get_entry(&self, key: &str) -> Result<Option<StoredEntry>, RustAuthError> {
        self.purge_expired()?;
...
mod tests {
    ...
    #[tokio::test]
    async fn set_if_not_exists_ttl_zero_is_non_destructive() -> Result<(), RustAuthError> {
