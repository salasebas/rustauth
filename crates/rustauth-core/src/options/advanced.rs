...
pub struct AdvancedOptions {
    ...
    pub outbound_min_response_time: Option<Duration>,
}
...
impl AdvancedOptions {
    ...
    #[must_use]
    pub fn outbound_min_response_time(mut self, duration: Duration) -> Self {
        self.outbound_min_response_time = Some(duration);
        self
    }
}
...
impl std::fmt::Debug for AdvancedOptions {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter
            ...
            .field(
                "outbound_min_response_time",
                &self.outbound_min_response_time,
            )
            .finish()
    }
}
