...
pub(super) fn hmac_base64(value: &str, secret: &str) -> Result<String, RustAuthError> {
...
pub fn sign_cookie_value(value: &str, secret: &str) -> Result<String, RustAuthError> {
    Ok(format!("{value}.{}", hmac_base64(value, secret)?))
}

pub fn verify_cookie_value(value: &str, secret: &str) -> Result<Option<String>, RustAuthError> {
