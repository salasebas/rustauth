...
fn hmac_base64url(value: &str, secret: &str) -> Result<String, RustAuthError> {
...
mod tests {
    ...
    #[test]
    fn jwe_cache_strategy_fails_closed_without_jose() -> Result<(), RustAuthError> {
        let cookies = get_cookies(&RustAuthOptions::default())?;
