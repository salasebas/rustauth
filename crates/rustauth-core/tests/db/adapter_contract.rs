...
#[tokio::test]
async fn adapter_trait_is_async_and_object_safe() -> Result<(), RustAuthError> {
    struct MockAdapter {
...
#[tokio::test]
async fn adapter_transaction_falls_back_to_current_adapter() -> Result<(), RustAuthError> {
...
#[tokio::test]
async fn adapter_transaction_can_be_overridden_by_real_adapter() -> Result<(), RustAuthError> {
