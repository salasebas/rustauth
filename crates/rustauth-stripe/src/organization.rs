use rustauth_core::db::{Count, DbAdapter, DbRecord, DbValue, FindMany, Update, Where};
...
fn active_delete_cancel() -> PluginDatabaseBeforeAction {
    PluginDatabaseBeforeAction::Cancel(RustAuthError::Api(
...
fn log_seat_sync_error(
    context: &rustauth_core::plugin::PluginDatabaseHookContext<'_>,
    result: Result<(), RustAuthError>,
) {
